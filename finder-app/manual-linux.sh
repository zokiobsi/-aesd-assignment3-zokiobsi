...
if [ ! -e ${OUTDIR}/linux-stable/arch/${ARCH}/boot/Image ]; then
    ...
    make ARCH=$ARCH CROSS_COMPILE=$CROSS_COMPILE defconfig #build default config
...
#TODO - go through and take notes of this stuff! 
# What is an elf file?
# 'readelf' when installing busybox - usefule tool to note